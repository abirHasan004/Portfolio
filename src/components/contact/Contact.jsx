...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_zs0618x', 'template_p8gunxb', form.current, 'DpY-b19Y6eprhxirT')
        e.target.reset();
    };
            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">abirh3759@gmail.com</span>
            ...
            <div className="contact__content">
                ...
                <form ref={form} onSubmit={sendEmail} className="contact__form">
                    <div className="contact__form-div">
                        ...
                        <input type="text" name="user_name" className="contact__form-input" placeholder="Type your name" />
                    </div>

                    <div className="contact__form-div">
                        <label className="contact__form-tag">Email</label>
                        <input type="email" name="user_email" className="contact__form-input" placeholder="Type your email" />
                    </div>
